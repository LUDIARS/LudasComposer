...
[`ergo/`](ergo/INDEX.md) — Ergo 各モジュールの **詳細実装ドキュメント** (Ars 視点)。 lexicon Feature を直接実装する 4 モジュール (health / score / combo_counter / timing_judge) の deep dive、 14 のインフラモジュール網羅、 統合パターン、 Phase 1-3 ロードマップ詳細。
